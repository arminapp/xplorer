...
│
├── habitability_analysis.py                         # Physics-based analysis script
├── xgboost_habitability.py                          # Machine learning script
├── exoplanet_habitability_analysis.ipynb            # Jupyter notebook submission
│
...
├── pr_curve.png                                     # Visualization: Precision-Recall
├── fig*.png                                         # Notebook figures
│
...
### Habitability Scores
- **All planets**: `cumulative_2025.10.04_15.04.09_habitability_scores.csv`
  - Columns: planet_name, disposition, radius, mass, temperature, ESI, HZ flags, habitability_score, category

### Top Candidates
- **Top 100**: `cumulative_2025.10.04_15.04.09_top_habitable.csv`
- **Top 20 summary**: `top_20_habitable_planets.csv`

### Machine Learning Predictions
- **All predictions**: `xgboost_habitability_predictions.csv`
  - Additional columns: ml_habitability_probability, ml_habitability_class

### Visualizations
- **`fig1_dataset_overview.png`** - Dataset composition showing disposition status and habitability categories
- **`fig2_physics_metrics.png`** - Key physics-based habitability metrics (ESI, temperature, mass-radius, HZ)
- **`fig3_top_candidates.png`** - Top 20 habitable candidates analysis with ESI vs temperature
- **`fig4_ml_analysis.png`** - XGBoost model performance and feature analysis
- **`fig5_physics_vs_ml.png`** - Comparison between physics-based and ML approaches
- **`feature_importance.png`** - XGBoost feature importance ranking
- **`roc_curve.png`** - ROC curve showing 99.7% AUC performance
- **`pr_curve.png`** - Precision-Recall curve for imbalanced dataset
- **`shap_summary.png`** - SHAP feature importance analysis
...
### Physics-Based Metrics (`fig2_physics_metrics.png`)
...
### Top Candidates Analysis (`fig3_top_candidates.png`)
...
### Machine Learning Performance (`fig4_ml_analysis.png`)
...
### Physics vs ML Comparison (`fig5_physics_vs_ml.png`)
...
open fig1_dataset_overview.png
open fig2_physics_metrics.png
open fig3_top_candidates.png
open fig4_ml_analysis.png
open fig5_physics_vs_ml.png
